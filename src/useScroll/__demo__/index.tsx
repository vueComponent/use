...
export default {
  setup() {
    ...
    const scroll = useScroll(eleRef);
    return { eleRef, scroll };
  },
  render(_ctx) {
    return (
      <>
        <div>{JSON.stringify(_ctx.scroll)}</div>
        <div
          style={{
            height: '160px',
            width: '160px',
        ...
        >
          ...
          <div>
            Alias aut deserunt expedita, inventore maiores minima officia porro rem. Accusamus
            ducimus magni modi mollitia nihil nisi provident
          </div>
          <div>
          ...
          <div>
            ...
            dignissimos distinctio, dolor eaque est fugit nisi non pariatur porro possimus, quas
            quasi
          </div>
        </div>
      </>
